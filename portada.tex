...
\begin{titlepage}
    ...
    \begin{flushright}
        ...
        Medidor atmosférico de material particulado fino} \\[1.5cm]

        % Autor
        {\fontfamily{phv}\fontsize{20pt}{25pt}\selectfont
        Mg. Luis Alberto Gómez Parada} \\[1cm]
        ...
        \textbf{Director:} Ing. Juan Manuel Cruz (FIUBA)} \\[0.3cm]
    
        {\fontfamily{phv}\fontsize{11pt}{15pt}\selectfont
    	\textbf{Co-director:} Zöe Flemming (UDD)} \\[1cm]
        ...
        Ciudad de Santiago, Junio de 2025} % Ejemplo: Ciudad de Córdoba, junio de 2025
    \end{flushright}
\end{titlepage}
